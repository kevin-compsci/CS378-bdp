...
public class WordCountB extends Configured implements Tool {
	 ...
	 */
	public static class ReduceClass extends Reducer<Text, AvroValue<WordCountData>, AvroKey<CharSequence>, AvroValue<WordCountData>> {

		@Override
		public void reduce(Text key, Iterable<AvroValue<WordCountData>> values, Context context) throws IOException, InterruptedException {
			long sum = 0L;
