...
public class Utils {
	...
	public static final String LARGE_EVENTS = "Events Size Over 100";
	public static final String CLICK_SAMPLE = "Clicker Sampling Rejected";
	public static final String SHOW_SAMPLE = "Shower Sampling Rejected";
